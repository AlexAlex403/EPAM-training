...
public class Main {
	private static List<Car> cars = Arrays.asList(
		new Sedan("", 170, 7.5, 20000, 200, FuelType.PETROL_92),
		new Sedan("", 180, 8.0, 25000, 220, FuelType.DIESEL),
		new Sedan("", 180, 8.5, 22000, 250, FuelType.GAS),
		new Coupe("", 210, 9.0, 30000, CoupeType.CABRIOLET, FuelType.PETROL_95),
		new Coupe("", 220, 10.0, 32000, CoupeType.ROADSTER, FuelType.DIESEL),
		new Coupe("", 250, 12.0, 40000, CoupeType.SPORTCAR, FuelType.PETROL_98),
		new Limousine("", 6, 140, 11.0, 31000, FuelType.DIESEL, LimousineFeature.TINTED_GLASS),
		new Limousine("", 4, 150, 10.5, 33000, FuelType.PETROL_95, LimousineFeature.QUALITY_SOUND)
	);
