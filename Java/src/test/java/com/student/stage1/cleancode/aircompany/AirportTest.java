...
public class AirportTest {
    ...
    public void testGetTransportMilitaryPlanes() {
        ...
        boolean isOnlyTransportPlanesInList = true;
        for (MilitaryPlane militaryPlane : transportMilitaryPlanes) {
            if ((militaryPlane.getMilitaryType() != MilitaryType.TRANSPORT)) {
                isOnlyTransportPlanesInList = false;
                break;
            }
        }
        Assert.assertTrue(isOnlyTransportPlanesInList);
    }
    ...
    public void testGetBomberMilitaryPlanes() {
        ...
        boolean isOnlyBomberPlanesInList = true;
        for (MilitaryPlane militaryPlane : bomberMilitaryPlanes) {
            if ((militaryPlane.getMilitaryType() != MilitaryType.BOMBER)) {
            	isOnlyBomberPlanesInList = false;
            }
        }
        Assert.assertTrue(isOnlyBomberPlanesInList);
    }
